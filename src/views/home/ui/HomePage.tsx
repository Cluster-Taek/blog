          ...
          <div className="gap-2 gap-y-6 flex flex-col md:flex-row justify-between">
            <div className="gap-3 flex flex-col order-2 md:order-1">
              <BlurFadeText
                ...
                yOffset={8}
              >
                <span className="font-extrabold">hi, i&apos;m {DATA.name.split(' ')[0]}</span>
              </BlurFadeText>
              <BlurFadeText
                className="text-muted-foreground max-w-[600px] md:text-lg lg:text-xl break-keep whitespace-pre-line"
                delay={BLUR_FADE_DELAY}
              >
                {DATA.description}
              </BlurFadeText>
